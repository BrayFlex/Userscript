...
const COLOURNAME = ['Dark Red', 'Red', 'Orange', 'Light Orange', 'Yellow', 'Pale Yellow', 'Dark Green', 'Green', 'Lime', 'Dark Teal', 'Teal', 'Blue Green', 'Dark Blue', 'Blue', 'Cyan', 'Dark Purple', 'Purple', 'Pale Blue', 'Dark Purple', 'Magenta', 'Light Purple', 'Fuchsia', 'Hot Pink', 'Salmon', 'Dark Brown', 'Brown', 'Peach', 'Black', 'Dark Grey', 'Grey', 'Light Grey', 'White'];  
